...
public class Word2VEC {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vec.loadJavaModel(".\\train_model");
        System.out.println(vec.distance("can"));
        System.out.println(vec.similarity("don't", "didn't"));
    ...
    public double similarity(String word1, String word2) {
        double sim = 0.0;
        Set<WordEntry> temp = this.distance(word1);
        Map<String, Float> wordlist = new HashMap<>();
        for (WordEntry w : temp) {
            wordlist.put(w.name, w.score);
        }
        if (wordlist.containsKey(word2)) {
            sim = wordlist.get(word2);
        }
        return sim;
    }
